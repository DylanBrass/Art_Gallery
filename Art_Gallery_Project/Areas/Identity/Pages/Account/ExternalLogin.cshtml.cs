...
namespace Art_Gallery_Project.Areas.Identity.Pages.Account
{
    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        public IActionResult OnPost(string provider, string returnUrl = null, string role = null)
        {
        ...
        public async Task<IActionResult> OnGetCallbackAsync(string returnUrl = null, string role = null,
            string remoteError = null)
        {
            ...
            else
            {
                ...
                _logger.LogInformation("User's role before page: {role}", role);
                return Page();
            }
        }

        public async Task<IActionResult> OnPostConfirmationAsync(string returnUrl = null, string role = null)
        {
            _logger.LogInformation("User's role in OnPostConfirm: {role}", role);
            returnUrl = returnUrl ?? Url.Content("~/");
