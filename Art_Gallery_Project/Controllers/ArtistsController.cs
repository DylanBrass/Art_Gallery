...
namespace Art_Gallery_Project.Controllers
{
    public class ArtistsController : Controller
    {
        ...
        public ArtistsController(Art_Gallery_ProjectContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Artist != null ? 
                          ...
                          Problem("Entity set 'Art_Gallery_ProjectContext.Artist'  is null.");
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FirstName,LastName,Bio")] Artist artist)
        {
            if (id != artist.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Art_Gallery_ProjectContext.Artist'  is null.");
            }
            var artist = await _context.Artist.FindAsync(id);
            if (artist != null)
            {
